...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
      <a href="logout.php" class="btn btn-danger mr-3">SALIR</a>
      </li>
    </ul>
  </nav>
  <!-- /.navbar -->
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index.php" class="brand-link">
      <img src="img/logodefensa.png" alt="Logo Defensa Civil" class="logo">
      <span class="brand-text font-weight-bold">Comunidad Alerta</span>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <!--<li class="nav-item">
            <a href="pages/widgets.html" class="nav-link">
              ...
              <p>
              Notificaciones
              <span class="right badge badge-danger">Nueva</span>
              </p>
            </a>
          </li>-->
